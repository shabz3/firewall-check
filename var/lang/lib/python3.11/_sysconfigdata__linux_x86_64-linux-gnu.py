...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BASEMODLIBS': '',
 'BINDIR': '/var/lang/bin',
 'BINLIBDEST': '/var/lang/lib/python3.11',
 'BLDLIBRARY': '-L. -lpython3.11',
 'BLDSHARED': 'gcc -pthread -shared -Wl,-rpath=/var/lang/lib',
 'BOOTSTRAP_HEADERS': '\\',
 'BUILDEXE': '',
 'BUILDPYTHON': 'python',
 ...
 'CONFIGURE_CFLAGS_NODIST': '-fno-semantic-interposition -flto '
                            ...
                            '-flto-partition=none -g -std=c11 -Wextra '
                            '-Wno-unused-parameter '
                            '-Wno-missing-field-initializers '
                            '-Werror=implicit-function-declaration '
                            '-fvisibility=hidden',
 'CONFIGURE_CPPFLAGS': '',
 'CONFIGURE_LDFLAGS': '-Wl,-rpath=/var/lang/lib',
 'CONFIGURE_LDFLAGS_NODIST': '-fno-semantic-interposition -flto '
                             '-fuse-linker-plugin -ffat-lto-objects '
                             '-flto-partition=none -g',
 'CONFIGURE_LDFLAGS_NOLTO': '-fno-lto',
 'CONFIG_ARGS': "'--prefix=/var/lang' '--with-openssl=/var/custom-openssl' "
                "'--with-openssl-rpath=auto' '--enable-shared' "
                "'--enable-optimizations' '--with-lto' "
                "'LDFLAGS=-Wl,-rpath=/var/lang/lib'",
 'CONFINCLUDEDIR': '/var/lang/include',
 'CONFINCLUDEPY': '/var/lang/include/python3.11',
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/var/python-src/coverage.info',
 'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
 'COVERAGE_REPORT': '/var/python-src/lcov-report',
 ...
 'DESTDIRS': '/var/lang /var/lang/lib /var/lang/lib/python3.11 '
             '/var/lang/lib/python3.11/lib-dynload',
 'DESTLIB': '/var/lang/lib/python3.11',
 'DESTPATH': '',
 'DESTSHARED': '/var/lang/lib/python3.11/lib-dynload',
 'DFLAGS': '',
 'DIRMODE': 755,
 ...
 'INCLDIRSTOMAKE': '/var/lang/include /var/lang/include '
                   '/var/lang/include/python3.11 /var/lang/include/python3.11',
 'INCLUDEDIR': '/var/lang/include',
 'INCLUDEPY': '/var/lang/include/python3.11',
 ...
 'LDLIBRARYDIR': '',
 'LDSHARED': 'gcc -pthread -shared -Wl,-rpath=/var/lang/lib',
 'LDVERSION': '3.11',
 'LIBC': '',
 'LIBDEST': '/var/lang/lib/python3.11',
 'LIBDIR': '/var/lang/lib',
 'LIBEXPAT_A': 'Modules/expat/libexpat.a',
 'LIBEXPAT_CFLAGS': '-I./Modules/expat -Wsign-compare -DNDEBUG -g -fwrapv -O3 '
                    '-Wall -fno-semantic-interposition -flto '
                    '-fuse-linker-plugin -ffat-lto-objects '
                    '-flto-partition=none -g -std=c11 -Wextra '
 ...
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/var/lang/lib/pkgconfig',
 'LIBPL': '/var/lang/lib/python3.11/config-3.11-x86_64-linux-gnu',
 'LIBPYTHON': '',
 ...
 'MACHDEP': 'linux',
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '/var/lang/lib/python3.11',
 'MACOSX_DEPLOYMENT_TARGET': '',
 'MAINCC': 'gcc -pthread',
 'MAJOR_IN_MKDEV': 0,
 'MAJOR_IN_SYSMACROS': 0,
 'MAKESETUP': './Modules/makesetup',
 'MANDIR': '/var/lang/share/man',
 ...
 'MODULE__HASHLIB_CFLAGS': '-I/var/custom-openssl/include',
 'MODULE__HASHLIB_DEPS': './Modules/hashlib.h',
 'MODULE__HASHLIB_LDFLAGS': '-L/var/custom-openssl/lib  '
                            '-Wl,--enable-new-dtags,-rpath=/var/custom-openssl/lib  '
                            '-lcrypto',
 ...
 'MODULE__SRE_LDFLAGS': '',
 'MODULE__SSL_CFLAGS': '-I/var/custom-openssl/include',
 ...
 'MODULE__SSL_LDFLAGS': '-L/var/custom-openssl/lib  '
                        '-Wl,--enable-new-dtags,-rpath=/var/custom-openssl/lib '
                        '-lssl -lcrypto',
 ...
 'OBJECT_OBJS': '\\',
 'OPENSSL_INCLUDES': '-I/var/custom-openssl/include',
 'OPENSSL_LDFLAGS': '-L/var/custom-openssl/lib',
 ...
 'PY_CFLAGS_NODIST': '-fno-semantic-interposition -flto -fuse-linker-plugin '
                     '-ffat-lto-objects -flto-partition=none -g -std=c11 '
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': 'LD_LIBRARY_PATH=/var/python-src',
 'SCRIPTDIR': '/var/lang/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SHELL': '/bin/sh',
 ...
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': 'LD_LIBRARY_PATH=/var/python-src ./python -E',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': 'LD_LIBRARY_PATH=/var/python-src ./python -E '
 ...
 'VERSION': '3.11',
 'WASM_ASSETS_DIR': './var/lang',
 'WASM_STDLIB': './var/lang/lib/python3.11/os.py',
 'WHEEL_PKG_DIR': '',
 'WINDOW_HAS_FLAGS': 1,
 ...
 'abs_builddir': '/var/python-src',
 'abs_srcdir': '/var/python-src',
 'datarootdir': '/var/lang/share',
 'exec_prefix': '/var/lang',
 'prefix': '/var/lang',
 'srcdir': '.'}
