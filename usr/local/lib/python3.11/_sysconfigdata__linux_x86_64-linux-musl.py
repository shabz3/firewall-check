...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BUILDEXE': '',
 'BUILDPYTHON': 'python',
 'BUILD_GNU_TYPE': 'x86_64-pc-linux-musl',
 'BYTESTR_DEPS': '\\',
 'CC': 'gcc',
 'CCSHARED': '-fPIC',
 ...
 'CONFIG_ARGS': "'--build=x86_64-linux-musl' "
                "'--enable-loadable-sqlite-extensions' "
                "'--enable-option-checking=fatal' '--enable-shared' "
                "'--with-lto' '--with-ensurepip' "
 ...
 'EXTRATESTOPTS': '',
 'EXTRA_CFLAGS': '',
 'EXT_SUFFIX': '.cpython-311-x86_64-linux-musl.so',
 'FILEMODE': 644,
 ...
 'LIBPL': '/usr/local/lib/python3.11/config-3.11-x86_64-linux-musl',
 'LIBPYTHON': '',
 ...
 'MODULE_BINASCII_LDFLAGS': '-L/lib -lz',
 ...
 'MULTIARCH_CPPFLAGS': '-DMULTIARCH=\\"x86_64-linux-musl\\"',
 ...
 'PY_CORE_CFLAGS': '-Wsign-compare -DNDEBUG -g -fwrapv -O3 -Wall -flto '
 ...
 'PY_STDMODULE_CFLAGS': '-Wsign-compare -DNDEBUG -g -fwrapv -O3 -Wall -flto '
 ...
 'SIZEOF_WCHAR_T': 4,
 'SIZEOF__BOOL': 1,
 'SOABI': 'cpython-311-x86_64-linux-musl',
 ...
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': 'LD_LIBRARY_PATH=/usr/src/python ./python -E '
